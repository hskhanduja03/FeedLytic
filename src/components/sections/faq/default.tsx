      ...
      <div className="mx-auto flex max-w-container flex-col items-center gap-8">
        ...
        <Accordion type="single" collapsible className="w-full max-w-[800px]">
          <AccordionItem value="item-1">
            <AccordionTrigger>What is FeedLytic?</AccordionTrigger>
            <AccordionContent>
              <p className="mb-4 max-w-[640px] text-balance text-muted-foreground">
                FeedLytic is an anonymous feedback platform that allows admins
                to share a unique link for users to submit honest feedback
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              How does FeedLytic ensure anonymity?
            </AccordionTrigger>
            <AccordionContent>
              <p className="mb-4 max-w-[600px] text-muted-foreground">
                FeedLytic does not collect personal details or track users.
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <p className="mb-4 max-w-[580px] text-muted-foreground">
                Currently, FeedLytic provides a simple and effective feedback
          ...
          <AccordionItem value="item-6">
            <AccordionTrigger>Is FeedLytic free to use?</AccordionTrigger>
            <AccordionContent>
              <p className="mb-4 max-w-[580px] text-muted-foreground">
                FeedLytic offers a basic free version, with potential premium
